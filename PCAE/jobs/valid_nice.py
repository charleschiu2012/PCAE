...
def valid_nice():
    ...
    if config.cuda.dataparallel_mode == 'Dataparallel':
        ...
        train_session = ValidNICESession(args=argument, dataloader=train_dataloader)
        train_session.valid()
        ...
        train_session = ValidNICESession(args=argument, dataloader=train_dataloader, sampler=train_sampler)
        train_session.valid()
